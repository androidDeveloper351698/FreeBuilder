...
public class SetSourceTest {
  ...
  public void test_guava_j6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "   * for use in unit tests. State checking will not be performed.",
        "   *",
        "   * <p>Partials should only ever be used in tests. They permit writing robust",
        "   * test cases that won't fail if this type gains more application-level",
        "   * constraints (e.g. new required fields) in future. If you require partially",
        "   * complete values in production code, consider using a Builder.",
        "   */",
        "  @VisibleForTesting()",
  ...
  public void test_guava_j7() {
    ...
    assertThat(source).isEqualTo(Joiner.on('\n').join(
        ...
        "  public Person.Builder addName(String element) {",
        "    if (this.name instanceof ImmutableSet) {",
        "      this.name = new LinkedHashSet<>(this.name);",
        "    }",
        "    this.name.add(Preconditions.checkNotNull(element));",
        "    return (Person.Builder) this;",
        "  }",
